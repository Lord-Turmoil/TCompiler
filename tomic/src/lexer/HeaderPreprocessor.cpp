...
HeaderPreprocessor::HeaderPreprocessor() : _state({ StateType::ANY, 0 })
{
}


void HeaderPreprocessor::Process()
{
...
HeaderPreprocessor* HeaderPreprocessor::SetReader(twio::IReaderPtr reader)
{
...
HeaderPreprocessor* HeaderPreprocessor::SetWriter(twio::IWriterPtr writer)
{
...
void HeaderPreprocessor::_Process(int ch)
{
    switch (_state.type)
    {
    case StateType::ANY:
...
void HeaderPreprocessor::_ProcessAny(int ch)
{
    switch (ch)
    {
    case '/':
...
void HeaderPreprocessor::_ProcessSlash(int ch)
{
    switch (ch)
    {
    case '/':
...
void HeaderPreprocessor::_ProcessLineComment(int ch)
{
    switch (ch)
    {
    case '\n':
...
void HeaderPreprocessor::_ProcessBlockCommentLeft(int ch)
{
    switch (ch)
    {
    case '*':
...
void HeaderPreprocessor::_ProcessBlockCommentRight(int ch)
{
    switch (ch)
    {
    case '/':
...
void HeaderPreprocessor::_ProcessQuote(int ch)
{
    if (ch == EOF)
    {
        return;
