...
#ifndef _TOMIC_DEFAULT_LEXICAL_ANALYSER_H_
#define _TOMIC_DEFAULT_LEXICAL_ANALYSER_H_
 ...
 */
class DefaultLexicalAnalyser : public ILexicalAnalyser
{
public:
    DefaultLexicalAnalyser();
    ~DefaultLexicalAnalyser() override = default;

    DefaultLexicalAnalyser* SetReader(twio::IAdvancedReaderPtr reader) override;
